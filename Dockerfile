...
RUN echo "ROS_MASTER_URI=http://localhost:11311" >> /root/.bashrc
RUN echo "ROS_IP=127.0.0.1" >> /root/.bashrc
...
RUN echo "export LD_LIBRARY_PATH=/opt/ros/kinetic/lib:/usr/local/lib/python3.6/dist-packages/spconv:$LD_LIBRARY_PATH" >> /root/.bashrc
